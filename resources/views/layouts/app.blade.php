...
<h2 class="text-2xl font-semibold tracking-tight text-slate-900">{{ __('Dashboard') }}</h2>
    ...
    <div class="relative" id="notifWrapper">
        ...
        <div id="notifDropdown" style="display:none;position:absolute;left:0;top:44px;width:340px;background:#fff;border:1.5px solid #e5e7eb;border-radius:14px;box-shadow:0 8px 32px rgba(0,0,0,.12);z-index:999;">
            <div style="padding:14px 16px;border-bottom:1px solid #f3f4f6;display:flex;justify-content:space-between;align-items:center;">
                <span style="font-size:13px;font-weight:800;color:#111827;">🔔 الإشعارات</span>
