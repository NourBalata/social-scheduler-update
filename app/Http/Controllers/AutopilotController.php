...
class AutopilotController extends Controller
{
    ...
    private function buildMonthPrompt(array $data, int $count): string
    {
        ...
        Requirements:
        1. 'Language: Same language as the business name and audience. If Arabic, write in Arabic.',
    ...
    private function buildSinglePrompt(array $data): string
    {
        ...
        return "Write a high-quality Facebook post for {$formattedDate}. Use the same language as the business context provided.
